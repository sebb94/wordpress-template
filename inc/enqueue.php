...
function seba_load_scripts(){
      wp_enqueue_style('bootstrap',get_template_directory_uri() . '/css/bootstrap.min.css', array(), '4.3.1', 'all');
       ...
       /* jquery do stopki */
        ...
        wp_register_script('jquery', get_template_directory_uri() . '/js/query.js', false, '3.3.1',false);
        wp_enqueue_script('jquery');
     //////////////////////////
     wp_enqueue_script('poper','https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js' , array('jquery'), '4.3.1', false); 
       wp_enqueue_script('bootstrap',get_template_directory_uri() . '/js/bootstrap.min.js' , array('jquery','poper'), '4.3.1', false); 
